...
public class BitmapStore {
    ...
    private static com.myapp.quizphatgiao.BitmapStore mOurInstance;
    // Calling this method is the only way to get a BitmapStore
    static com.myapp.quizphatgiao.BitmapStore getInstance(Context context) {
        mOurInstance = new com.myapp.quizphatgiao.BitmapStore(context);
        return mOurInstance;
    }
